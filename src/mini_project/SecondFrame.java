...
public class SecondFrame {
	...
	public SecondFrame()
	{
		...
		lblFcode.setBounds(36, 139, 76, 31);
		...
		lblFlightDetails.setBounds(248, 11, 235, 31);
			...
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 String code =textField.getText();
					...
					try {
						...
						ResultSet myrs;
						pst=mycon.prepareStatement("select A.f_name,A.src,A.dst,B.capacity,B.class_code,B.class_name from airline.flight A,airline.sector B where A.f_code=B.flight_code and f_code=? ");
